...
namespace WSSS.Helpers
{
    ...
    {
        public static MemoryStream ExportExcel<T>(List<T> list)
        {
            string excelHeader = GetClassExcel<T>();
            return ExportExcel(list, excelHeader);
        }
        ...
        public static MemoryStream ExportExcel<T>(List<T> list, string excelHeader)
        {
            ...
            HSSFWorkbook hssfworkbook = ListToWorkbook(list, excelHeader);
            hssfworkbook.Write(memoryStream);
            memoryStream.Seek(0, SeekOrigin.Begin);
            return memoryStream;
        }

        public static HSSFWorkbook ListToWorkbook<T>(List<T> list, string excelHeader)
        {
